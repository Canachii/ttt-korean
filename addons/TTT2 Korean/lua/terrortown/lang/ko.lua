...
--Credit awards
L.credit_all = "임무 수행에 따른 {num} 크레딧을 받았습니다."
...
L.radio_button_shotgun = "Shotgun 발사음"
L.radio_button_rifle = "Rifle 발사음"
...
L.menu_addons_title = "TTT2 전용 에드온 설정"
L.menu_legacy_title = "TTT 대응 에드온 설정"
...
L.help_scale_factor = "이 배율은 모든 UI요소에 영향을 줍니다(예를 들면 HUD, VGUI와 타겟 ID). 화면 해상도가 변경되면 자동적으로 갱신합니다. 이 값을 변경하면 HUD가 초기화됩니다."
...
L.help_targetid_info = "타겟 ID는 대상을 바라볼 때 표시되는 정보입니다. '기본' 설정 패널로 고정 색을 설정 가능합니다."
...
L.label_minimal_targetid = "크로스헤어 아래의 타겟 ID를 최소화(카르마, 팁 등 숨김)"
...
--2021-10-06
L.menu_server_addons_title = "서버 에드온"
...
L.label_allow_discomb_jump = "Discombobulator의 점프"
...
L.label_highlight_addondev = "TTT2에드온 개발자의 하이라이트"
